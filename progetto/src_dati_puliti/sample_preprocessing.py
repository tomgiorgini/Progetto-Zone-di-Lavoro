...
if __name__ == "__main__":
    ...
    modes = ['RF-HR-VO2-VCO2-VE/VO2-VE/VCO2-Q-VO2/HR','VO2-VCO2','VE/VO2-VE/VCO2','RF-HR','Q-HR','Q-RF','HR']
    ...
    print(df)
    with open(Path(ROOT_DIR) / f'progetto/src_dati_puliti/{filename}', 'wb') as f:
        dump(df, f)