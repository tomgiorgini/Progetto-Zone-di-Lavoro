...
if __name__ == "__main__":
    ...
    titles = ['Risultati del Sequence Predictor con Random Forest, dati puliti','Risultati del Sequence Predictor con SVC, dati puliti']
    pngs = ['seq_predictor_results_dati_puliti_rf.png','seq_predictor_results_dati_puliti_svc.png']
    k = 0
    for e in compareseq:
        cmap = "Blues"
        labels = ['Riposo','Aerobica','Anaerobica']
        f, axes = plt.subplots(5, 2, figsize=(20,10))
