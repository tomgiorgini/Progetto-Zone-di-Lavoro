...
if __name__ == "__main__":
    ...
    rf_params = [{'n_estimators': 500,'max_depth': None, 'max_features': 'sqrt', 'max_leaf_nodes': None, 'min_samples_split': 3},
                 ...
                 {'n_estimators': 500,'max_depth': None, 'max_features': 'log2', 'max_leaf_nodes': None, 'min_samples_split': 5},
    ...
    classifiers = [
                  [[KNeighborsClassifier(**(knn_params[2])),KNeighborsClassifier(**(knn_params[0])),KNeighborsClassifier(**(knn_params[1]))],
                   [RandomForestClassifier(**(rf_params[0])),RandomForestClassifier(**(rf_params[1])),RandomForestClassifier(**(rf_params[1]))],
                   [svm.SVC(**(svc_params[1])),svm.SVC(**(svc_params[5])),svm.SVC(**(svc_params[0]))]],
                  
                  [[KNeighborsClassifier(**(knn_params[0])),KNeighborsClassifier(**(knn_params[0])),KNeighborsClassifier(**(knn_params[2]))],
                   [RandomForestClassifier(**(rf_params[1])),RandomForestClassifier(**(rf_params[1])),RandomForestClassifier(**(rf_params[3]))],
                   [svm.SVC(**(svc_params[1])),svm.SVC(**(svc_params[5])),svm.SVC(**(svc_params[2]))]],
                  
                  [[KNeighborsClassifier(**(knn_params[0])),KNeighborsClassifier(**(knn_params[0])),KNeighborsClassifier(**(knn_params[0]))],
                   [RandomForestClassifier(**(rf_params[1])),RandomForestClassifier(**(rf_params[1])),RandomForestClassifier(**(rf_params[2]))],
                   [svm.SVC(**(svc_params[4])),svm.SVC(**(svc_params[6])),svm.SVC(**(svc_params[5]))]],
                  
                  [[KNeighborsClassifier(**(knn_params[0])),KNeighborsClassifier(**(knn_params[0])),KNeighborsClassifier(**(knn_params[0]))],
                   [RandomForestClassifier(**(rf_params[2])),RandomForestClassifier(**(rf_params[1])),RandomForestClassifier(**(rf_params[1]))],
                   [svm.SVC(**(svc_params[4])),svm.SVC(**(svc_params[6])),svm.SVC(**(svc_params[5]))]],
                  
                  [[KNeighborsClassifier(**(knn_params[0])),KNeighborsClassifier(**(knn_params[0])),KNeighborsClassifier(**(knn_params[0]))],
                   [RandomForestClassifier(**(rf_params[4])),RandomForestClassifier(**(rf_params[1])),RandomForestClassifier(**(rf_params[5]))],
                   [svm.SVC(**(svc_params[4])),svm.SVC(**(svc_params[6])),svm.SVC(**(svc_params[5]))]]
    ]
    
    target_names = ['Riposo','Aerobica','Anaerobica','Defaticamento']
    ...
    with open(Path(ROOT_DIR) / f'progetto/src_4zone/results/{filename}', 'wb') as f:
        dump(results, f)