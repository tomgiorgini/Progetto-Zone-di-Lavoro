...
if __name__ == "__main__":
    ...
    titles = ['Risultati del Sequence Predictor con KNeighbors, 4 zone','Risultati del Sequence Predictor con Random Forest, 4 zone','Risultati del Sequence Predictor con SVC, 4 zone']
    pngs = ['seq_predictor_results_4zone_knn.png','seq_predictor_results_4zone_rf.png','seq_predictor_results_4zone_svc.png']
    k = 0
    for e in compareseq:
        cmap = "Blues"
        labels = ['Riposo','Aerobica','Anaerobi','Defat']
