...
if __name__ == "__main__":
    ...
    with open(Path(ROOT_DIR) / f'progetto/data/{filename}','rb') as f:
    ...
    with open(Path(ROOT_DIR) / f'progetto/src/defaticamento/output/{filename}',"w") as f:
        print('',file=f)
    knn = KNeighborsClassifier()
    for l in seq_len:
        print("\nTUNING KNN WITH SEQ_LEN = ",l)
        with open(Path(ROOT_DIR) / f'progetto/src/defaticamento/output/{filename}',"a") as f:
