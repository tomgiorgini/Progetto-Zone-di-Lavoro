...
if __name__ == "__main__":
    ...
    classifiers = [[KNeighborsClassifier(**(params[0][0])),KNeighborsClassifier(**(params[0][2])),KNeighborsClassifier(**(params[0][2])),
                    KNeighborsClassifier(**(params[0][2])),KNeighborsClassifier(**(params[0][2])),KNeighborsClassifier(**(params[0][3])),
                    KNeighborsClassifier(**(params[0][4]))],
